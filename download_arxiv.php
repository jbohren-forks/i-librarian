...
########## display search result summaries ##############
    ...
    if (!empty($xml)) {
        ...
        $xml->registerXPathNamespace('j', 'http://arxiv.org/schemas/atom');
        $xml->registerXPathNamespace('count', 'http://a9.com/-/spec/opensearch/1.1/');
        $totalresults = $xml->xpath('//count:totalResults');
