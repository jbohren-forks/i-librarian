    ...
    if (!empty($webenv) && !empty($querykey)) {
        ...
        if ($count > 0) {
            ...
            print '<div class="ui-state-highlight ui-corner-top'.($retstart == 1 ? ' ui-state-disabled' : '').'" style="float:left;margin-left:2px;width:26px">'
                    .($retstart == 1 ? '' : '<a class="navigation" href="'.htmlspecialchars('download.php?webenv='.urlencode($webenv).'&querykey='.urlencode($querykey).'&retstart=1&count='.$count).'" style="display:block;width:26px">').
            ...
            print '<div class="ui-state-highlight ui-corner-top'.($retstart == 1 ? ' ui-state-disabled' : '').'" style="float:left;margin-left:2px">'
                    .($retstart == 1 ? '' : '<a class="navigation" href="'.htmlspecialchars('download.php?webenv='.urlencode($webenv).'&querykey='.urlencode($querykey).'&retstart='.($retstart-10).'&count='.$count).'" style="color:black;display:block;width:100%">').
            ...
            foreach ($xml->DocSum as $docsum) {
                ...
                if (isset($id) && isset($title) && isset($journal)) {
                    ...
                    print '<div class="items" id="UID-'.urlencode($id).'">';
                    ...
                    if ($existing_id['count(*)'] > 0) print ';color: #999';
                    ...
                    if ($j < $retstart+10 && $j < $retend) print '<div class="separator"></div>';
