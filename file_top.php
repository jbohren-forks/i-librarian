...
if (isset($_GET['file'])) {
    ...
    if (!empty($paper['id'])) {
        ...
        if (!empty($paper['authors'])) {
            ...
            print '<div class="authors"><span class="author_expander ui-icon ui-icon-circlesmall-plus" style="float:left"></span><div>'.htmlspecialchars($authors_string).'</div></div>';
        }

        if (!empty($paper['affiliation']))
            print '<div class="authors"><span class="author_expander ui-icon ui-icon-circlesmall-plus" style="float:left"></span><div>' . $paper['affiliation'] . '</div></div>';
