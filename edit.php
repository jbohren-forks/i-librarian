...
##########	read reference data	##########
    ...
    <?php if (!empty($error))
        print "$('#dialog-confirm').html('<p><span class=\"ui-state-error-text\"><span class=\"ui-icon ui-icon-alert\" style=\"float:left;margin:0px 7px 20px 0px\"></span></span>$error</p>').dialog('option','title','Error!').dialog('open');";
    ?>
    </script>
    <?php
} else {
