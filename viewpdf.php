...
if (isset($_GET['renderbookmarks'])) {
    ...
    if (file_exists($pdf_path . DIRECTORY_SEPARATOR . $file)) {
        ...
        $temp_file = $temp_dir.DIRECTORY_SEPARATOR.'i-librarian'.DIRECTORY_SEPARATOR.$safe_file_name.'-bookmarks.txt';
...
<?php include_once 'style.php'; ?>
    ...
    <body class="alternating_row" style="padding:0;margin:0;border:0;overflow:hidden">
        <div style="width:100%;height:62px<?php if (isset($_GET['toolbar']) && $_GET['toolbar'] == 0)
    print ';display:none'; ?>" id="pdf-viewer-controls">
            <div style="overflow:hidden;height:30px">
                <table>
                    <tr>
                        <td style="padding:2px 0 0 4px;line-height:26px">
                        ...
                        <td style="padding-left:4px;padding-top:8px;line-height:26px">
                        ...
                        <td style="padding:2px 0 0 4px;line-height:26px">
                            <input type="text" id="control-page" size="3" style="width:3em" value="<?php print intval($page) ?>"> / <?php print $page_number ?>
                        </td>
            ...
            <div style="overflow:hidden;height:32px">
                <table>
                    <tr>
                        ...
                        <td style="padding:2px 0 0 4px;line-height:26px">
                            <input type="text" id="pdf-viewer-search" size="10" value="" placeholder="Find" style="width:110px"
