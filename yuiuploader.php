...
if(!empty($_FILES)) {
    ...
    if (isset($_FILES['Filedata']) && is_uploaded_file($_FILES['Filedata']['tmp_name'])) {
        ...
        if (is_readable($file)) {
            ...
            if (file_exists($temp_dir.DIRECTORY_SEPARATOR."librarian_temp".$i.".txt")) $string = file_get_contents ($temp_dir.DIRECTORY_SEPARATOR."librarian_temp".$i.".txt");
...
<form id="batchimportform2" action="yuiuploader.php" method="GET">
