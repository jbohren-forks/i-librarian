...
if (isset($_SESSION['auth']) && isset($_SESSION['permissions']) && $_SESSION['permissions'] == 'A') {
    ...
    $extensions = array('pdo' => 'built-in database',
        'pdo_sqlite' => 'built-in database');
    ...
    print "<tr><td class=\"details alternating_row\" style=\"width: 100%\" colspan=4>Recommended PHP extensions:</td></tr>";

    $extensions = array('zip' => 'export to ZIP',
        'gd' => 'icon views, and PDF viewer',
        'apc' => 'caching - increased speed');
    ...
    print '<td class="details" id="details-1" style="white-space: nowrap;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    print '<td class="details" id="details-2" style="font-weight: bold;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    ...
    print '<td class="details" id="details-3" style="white-space: nowrap;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    print '<td class="details" id="details-4" style="font-weight: bold;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    ...
    print '<td class="details" id="details-5" style="white-space: nowrap;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    print '<td class="details" id="details-6" style="font-weight: bold;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    ...
    print '<td class="details" id="details-7" style="white-space: nowrap;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    print '<td class="details" id="details-8" style="font-weight: bold;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    ...
    print '<td class="details" id="details-9" style="white-space: nowrap;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    print '<td class="details" id="details-10" style="font-weight: bold;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    ...
    print '<td class="details" id="details-11" style="white-space: nowrap;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    print '<td class="details" id="details-12" style="font-weight: bold;height:19px;line-height:19px"><img src="img/ajaxloader2.gif" style="vertical-align:middle"></td>';
    ...
    if (!empty($isapc)) {
        $mem = apc_sma_info();
        $apc_size=($mem['num_seg']*$mem['seg_size'])/(1024*1024);
        $apc_used=$apc_size-($mem['avail_mem']/(1024*1024));
        $apc_perc = 100*$apc_used/$apc_size;
        print '<tr><td class="details alternating_row" colspan=4>APC Caching:</td></tr>';
        print '<tr><td>&nbsp;Shared memory usage:</td colspan=3><td>'
            . round($apc_perc,1).'% ('
            . round($apc_used,1)
            . ' MB out of '
            . round($apc_size) .' MB)</td></tr>';
    }
