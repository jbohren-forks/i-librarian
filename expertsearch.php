                    ...
                    <table cellspacing=0>
                        <tr>
                            <td class="select_span" style="line-height:16px">
                                ...
                                <span class="ui-icon ui-icon-radio-<?php print (isset($_SESSION['session_include-categories']) && $_SESSION['session_include-categories'] == 1) ? 'off' : 'on' ?>" style="float:left">
                                </span>Include
                            </td>
                            <td class="select_span" style="line-height:16px">
                                ...
                                <span class="ui-icon ui-icon-radio-<?php print (isset($_SESSION['session_include-categories']) && $_SESSION['session_include-categories'] == 2) ? 'off' : 'on' ?>" style="float:left">
