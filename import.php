            ...
            foreach ($records as $record) {
                ...
                if (!empty($authors)) {
                    ...
                    foreach ($authors as $author) {
                        ...
                        $first_name = '';
                        if (isset($author_array[1])) $first_name = $author_array[1];
            ...
            if (!empty($file_contents)) {
                ...
                foreach ($file_records as $record) {
                    ...
                    if ($title == 1) {
                        ...
                        if($journal == '') $journal = $secondary_title;
                        ...
                        <table cellspacing="0">
                            <tr>
                                <td class="select_span" style="width: 12em">
                                    ...
                                    <span class="ui-icon ui-icon-radio-on" style="float:left"></span>RIS* (+PDFs**)
                                </td>
