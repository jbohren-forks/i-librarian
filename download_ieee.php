        ...
        <form enctype="application/x-www-form-urlencoded" action="download_ieee.php" method="GET" id="download-form">	
            ...
            <table class="threed" width="99%">
                <tr>
                    ...
                    <td class="threed">
                        <input type="checkbox" value="4294967269" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967269', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        IEEE
                        <input type="checkbox" value="4293612683" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4293612683', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        AIP
                        <input type="checkbox" value="4294967119" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967119', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        IET
                        <input type="checkbox" value="4293292639" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4293292639', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        AVS
                        <input type="checkbox" value="4292403457" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4292403457', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        IBM
                        <input type="checkbox" value="4292760466" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4292760466', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        VDE
                        <input type="checkbox" value="4283401643" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4283401643', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        BIAI
                        <input type="checkbox" value="4283401642" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4283401642', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                        TUP
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="threed">
                        <div style="float:left;margin-right:10px">
                            <input type="checkbox" value="4291944822" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4291944822', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Conference Publications<br>
                            <input type="checkbox" value="4291944246" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4291944246', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Journals &amp; Magazines<br>
                            <input type="checkbox" value="4291944823" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4291944823', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Books &amp; eBooks
                        </div>
                        <div>
                            <input type="checkbox" value="4291944245" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4291944245', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Early Access Articles<br>
                            <input type="checkbox" value="4294965216" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294965216', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Standards<br>
                            <input type="checkbox" value="4291944243" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4291944243', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Education &amp; Learning
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="threed">
                        <div style="float:left;margin-right:10px">
                            <input type="checkbox" value="4294967045" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967045', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Computing &amp; Processing<br>
                            <input type="checkbox" value="4294967046" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967046', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Components, Circuits, Devices &amp; Systems<br>
                            <input type="checkbox" value="4294967114" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967114', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Communication, Networking &amp; Broadcasting<br>
                            <input type="checkbox" value="4294967044" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967044', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Engineered Materials, Dielectrics &amp; Plasmas<br>
                            <input type="checkbox" value="4294966781" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294966781', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Signal Processing &amp; Analysis<br>
                            <input type="checkbox" value="4294967042" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967042', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Power, Energy &amp; Industry Applications<br>
                            <input type="checkbox" value="4294967254" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967254', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Fields, Waves &amp; Electromagnetics<br>
                            <input type="checkbox" value="4294967113" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967113', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Photonics &amp; Electro-Optics<br>
                        </div>
                        <div>
                            <input type="checkbox" value="4294966917" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294966917', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            General Topics for Engineers<br>
                            <input type="checkbox" value="4294961108" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294961108', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Bioengineering<br>
                            <input type="checkbox" value="4294967010" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967010', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Robotics &amp; Control Systems<br>
                            <input type="checkbox" value="4294967026" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967026', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Aerospace<br>
                            <input type="checkbox" value="4294966918" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294966918', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Engineering Profession<br>
                            <input type="checkbox" value="4294967025" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967025', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Transportation<br>
                            <input type="checkbox" value="4294967043" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294967043', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Geoscience<br>
                            <input type="checkbox" value="4294964254" name="ieee_refinements[]"<?php print (is_array($_SESSION['session_download_ieee_refinements']) && in_array('4294964254', $_SESSION['session_download_ieee_refinements'])) ? ' checked' : ''  ?>>
                            Nuclear Engineering
                        </div>
                    </td>
                </tr>
